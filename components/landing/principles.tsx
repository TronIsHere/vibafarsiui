...
const items = [
  { icon: AlignRight, t: "راست‌چین واقعی", d: "چیدمان و آیکون‌ها از پایه راست‌چین طراحی شدن، چون یک dir روی کل صفحه کافی نیست." },
  { icon: Type, t: "تایپوگرافی فارسی", d: "وزن فونت و ارتفاع خط برای فارسی تنظیم شده و letter-spacing هم حروف را از هم جدا نمی‌کنه." },
  { icon: Hash, t: "اعداد و تقویم شمسی", d: "اعداد فارسی، جداکننده‌ی هزارگان، تومان و تاریخ شمسی همه داخل خود کامپوننت هستن." },
  { icon: Palette, t: "رنگ از توکن", d: "هر رنگ از یک متغیر CSS می‌آد. تم تیره پیش‌فرضه و با چند خط می‌تونید عوضش کنید." },
];
