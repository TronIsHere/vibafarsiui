...
export function DesignSystems({ standalone }: { standalone?: boolean }) {
  ...
  const head = (
    <SectionHead
      ...
      desc="رنگ، شعاع گوشه و کنتراست همه از توکن‌های CSS می‌آن. با دکمه‌ی «اعمال» کل سایت با همان تم عوض میشه و انتخابتون در مرورگر می‌مونه. روی اسم هر تم بزنید تا توکن‌ها و پرامپتش را ببینید."
      href="/themes"
