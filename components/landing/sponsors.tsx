...
const perks = [
  {
    ...
    d: "کنار خود کامپوننت‌ها دیده می‌شه، نه توی یک فوتر گم‌شده.",
  },
  {
    icon: FileText,
    t: "نام در README",
    d: "کسانی که از گیت‌هاب میان، اسم شما را همان‌جا می‌بینن.",
  },
  {
    icon: Pin,
    t: "صندلی ثابت",
      ...
      <div className="flex flex-col gap-5 border-b border-border px-5 py-8 sm:flex-row sm:items-end sm:justify-between sm:px-8">
        <div>
          ...
          <p className="mt-2 max-w-xl text-sm text-muted-foreground sm:text-[15px]">
            ...
            سرور می‌شه؛ لوگوشون کنار خود کامپوننت‌ها روی صفحه‌ی اول می‌شینه.
          </p>
        </div>
        <a
          href={SPONSOR_URL}
